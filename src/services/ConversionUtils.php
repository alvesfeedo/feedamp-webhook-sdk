...
class ConversionUtils
{
     ...
     * @return string
     */
    static function convert_usa_state_to_2_chars($state_code)
    {
     ...
     * @return string
     */
    static public function convert_date_to_utc_iso_8601(?string $date, $timezone = 'UTC')
    {
        if (!$date) {
            return '';
        }
     ...
     */
    static function convert_country_code_to_ISO3($country_code){
        $working_country_code = strtoupper($country_code);
